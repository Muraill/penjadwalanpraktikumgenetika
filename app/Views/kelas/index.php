        ...
        <div class="row">
            <div class="col">
                ...
                <div class="table-responsive">
                    <a href="/kelas/tambah" class="btn btn-primary btn-tambah">Tambah</a>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($kelas as $m) : ?>
                                <tr>
                                    ...
                                    <td><?= $m['nama_kelas']; ?></td>
                                    <td>
                                        <a href="/kelas/edit/<?= $m['id']; ?>" class="btn btn-warning btn-sm">Update</a>
                                        <form action="/kelas/delete/<?= $m['id']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
