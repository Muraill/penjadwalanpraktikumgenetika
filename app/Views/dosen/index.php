        ...
        <div class="row">
            <div class="col">
                ...
                <div class="table-responsive">
                    <a href="/dosen/tambah" class="btn btn-primary btn-tambah">Tambah</a>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($dosen as $d) : ?>
                                <tr>
                                    ...
                                    <td><?= $d['nama_dosen']; ?></td>
                                    <td>
                                        <a href="/dosen/edit/<?= $d['id']; ?>" class="btn btn-warning btn-sm">Update</a>
                                        <form action="/dosen/delete/<?= $d['id']; ?>" method="post" class="d-inline">
                                            <?= csrf_field(); ?>
